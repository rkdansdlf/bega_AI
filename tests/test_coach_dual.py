...
class TestCoachDualAnalysis:
    ...
    def test_build_coach_query_dual(self):
        ...
        query_reg = _build_coach_query(
            "KIA", ["batting"], "LG", league_ctx_reg
        )
        ...
        query_post = _build_coach_query(
            "KIA", [], "Samsung", league_ctx_post
        )
    ...
    def test_format_coach_context_dual(self):
        ...
        tool_results = {
            "home": {
                "summary": {"team_name": "KIA", "top_batters": [{"player_name": "Kim", "ops": 1.0}]},
                "advanced": {"metrics": {"batting": {"ops": 0.9}}}
            },
            "away": {
                "summary": {"team_name": "LG", "top_batters": [{"player_name": "Lee", "ops": 0.9}]},
                "advanced": {"metrics": {"batting": {"ops": 0.8}}}
            },
            "matchup": {
                "team1": "KIA",
                "team2": "LG",
                "summary": {"total_games": 10, "team1_wins": 5, "team2_wins": 5, "draws": 0},
                "games": [{"game_date": "2024-05-01", "home_score": 5, "away_score": 4, "game_result": "team1_win"}]
            }
        }
    ...
    def test_recent_form_in_context(self):
        ...
        team_data = {
            ...
            "recent": {
                ...
                "games": [
                    {"date": "2024-09-01", "opponent": "LG", "score": "5:3", "result": "Win", "run_diff": 2},
                    {"date": "2024-09-02", "opponent": "LG", "score": "2:4", "result": "Loss", "run_diff": -2},
                    {"date": "2024-09-03", "opponent": "LG", "score": "6:1", "result": "Win", "run_diff": 5},
                ],
            },
        }
