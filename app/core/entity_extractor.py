    ...
    for match in unique_matches:
        if match not in TEAM_MAPPING and match not in STAT_MAPPING:
            ...
            common_terms = {
                ...
                "내년", "재작년", "지난해", "어제", "오늘", "내일", "최근", "현재",
                
                "마지막", "최종", "결승", "우승", "준우승", "시합", "대결",
                "승리", "패배", "무승부", "연장", "취소", "종료", "시작",
                
                "우승팀", "챔피언", "등수", "순위표", "주요", "선수단", "로스터", 
                "라인업", "명단", "구단", "감독", "코치",
                
                "홈런", "안타", "득점", "실점", "승률", "세이브", "타점", "출루율",
                "장타율", "도루", "삼진", "볼넷", "타수", "타석", "등판", "완투",
                
                "조건", "자격", "규정", "규칙", "제도", "방법", "방식", "기준",
                
                "정보", "내용", "결과", "현황", "상황", "전망", "예상", "분석",
                "소식", "뉴스", "발표", "공식", "확정", "변경", "연기",
                
                "어디", "누구", "언제", "어떻게", "왜", "무엇", "얼마", "몇",
                "어떤", "무슨",
