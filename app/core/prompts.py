...
{{
  ...
  "key_metrics": [
    ...
    {{"label": "폼 진단", "value": "[원정팀] 보합 52.0 / [홈팀] 상승 64.5", "status": "good", "trend": "neutral", "is_critical": false}},
    {{"label": "최대 WPA 변동", "value": "8회말 홍길동 +18.4%p", "status": "warning", "trend": "neutral", "is_critical": true}}
  ],
  "analysis": {{
